...
OMR_HOST=${OMR_HOST:-$(hostname -I 2>/dev/null | awk '{print $1}')}
[ -z "$OMR_HOST" ] && OMR_HOST=127.0.0.1
...
OMR_RELEASE=${OMR_RELEASE:-v0.62.4-3K}
...
OMR_FEED_SRC="${OMR_FEED_SRC:-omr-v0.62.4-3K-bandwidth-only}"
